...
public class UndeadArmyManagerOld extends SavedData {
	...
	public UndeadArmyManagerOld( ServerLevel world ) {
		this.level = world;
	}
	...
	public static UndeadArmyManagerOld load( CompoundTag nbt, ServerLevel level ) {
		UndeadArmyManagerOld armyManager = new UndeadArmyManagerOld( level );
