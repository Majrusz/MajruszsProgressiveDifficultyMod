...
import com.majruszsdifficulty.items.AttributeArmorItem;
import com.majruszsdifficulty.items.FakeItem;
import com.majruszsdifficulty.loot_modifiers.AddTreasureBagsToLoot;
import com.majruszsdifficulty.loot_modifiers.DisableCertainLoot;
...
public class RegistryHandler {
	...
	private static void registerLootModifiers( DeferredRegister< GlobalLootModifierSerializer< ? > > lootModifiers ) {
		lootModifiers.register( "double_loot", DoubleLoot.Serializer::new );
		lootModifiers.register( "add_treasure_bag_to_loot", AddTreasureBagsToLoot.Serializer::new );
		lootModifiers.register( "disable_certain_loot", DisableCertainLoot.Serializer::new );
	}

	private static void registerPlacedFeatures( DeferredRegister< PlacedFeature > placedFeatures ) {
	}

	private static void registerBiomeModifiers( DeferredRegister< Codec< ? extends BiomeModifier > > biomeModifiers ) {
	}
	...
	private static void registerEverything( final IEventBus modEventBus ) {
		...
		REGISTER_HELPER.create( Registry.PLACED_FEATURE_REGISTRY, RegistryHandler::registerPlacedFeatures );
		REGISTER_HELPER.create( ForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, RegistryHandler::registerBiomeModifiers );
