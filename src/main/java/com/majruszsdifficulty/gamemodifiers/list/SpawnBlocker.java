...
public class SpawnBlocker extends GameModifier {
	...
	public SpawnBlocker() {
		...
		onCheckSpawn.addCondition( new Condition.ContextOnCheckSpawn( data->data.entity instanceof Illusioner && isVillageNearby( data.entity ) ) )
			.addCondition( new Condition.ContextOnCheckSpawn( data->this.isForbidden( data.entity ) ) )
