...
public class ZombiesInGroup extends GameModifier {
	static final Config.ItemStack TORCH = new Config.ItemStack( "SidekickTorch", "Chance for a sidekick to have a Torch (main hand).", ()->Items.TORCH, EquipmentSlot.MAINHAND, 1.0, 0.05, 0.0 );
	...
	static final Config.ItemStack COAL = new Config.ItemStack( "SidekickCoal", "Chance for a sidekick to have a Coal (offhand).", ()->Items.COAL, EquipmentSlot.OFFHAND, 0.2, 1, 0.0 );
	static final Config.ItemStack IRON_INGOT = new Config.ItemStack( "SidekickIronIngot", "Chance for a sidekick to have an Iron Ingot (offhand).", ()->Items.IRON_INGOT, EquipmentSlot.OFFHAND, 0.1, 1, 0.0 );
	static final Config.ItemStack GOLD_INGOT = new Config.ItemStack( "SidekickGoldIngot", "Chance for a sidekick to have a Gold Ingot (offhand).", ()->Items.GOLD_INGOT, EquipmentSlot.OFFHAND, 0.1, 1, 0.0 );
	static final Config.ItemStack DIAMOND = new Config.ItemStack( "SidekickDiamond", "Chance for a sidekick to have a Diamond (offhand).", ()->Items.DIAMOND, EquipmentSlot.OFFHAND, 0.025, 1, 0.0 );
	...
	static {
		...
		ON_SPAWNED.addCondition( new Condition.ContextOnSpawned( data->data.target instanceof Zombie ) );
		...
		MOB_GROUPS.addLeaderConfigs( IRON_HELMET, IRON_CHESTPLATE, IRON_LEGGINGS, IRON_BOOTS );
