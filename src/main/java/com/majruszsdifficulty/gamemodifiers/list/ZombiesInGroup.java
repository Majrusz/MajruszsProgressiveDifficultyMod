...
public class ZombiesInGroup extends GameModifier {
	...
	static final Config.ItemStack COAL = new Config.ItemStack( "SidekickCoal", "Chance for a sidekick to have a Coal (offhand).", ()->Items.COAL, EquipmentSlot.OFFHAND, 0.6, 1, 0.0 );
	static final Config.ItemStack IRON_INGOT = new Config.ItemStack( "SidekickIronIngot", "Chance for a sidekick to have an Iron Ingot (offhand).", ()->Items.IRON_INGOT, EquipmentSlot.OFFHAND, 0.4, 1, 0.0 );
	static final Config.ItemStack GOLD_INGOT = new Config.ItemStack( "SidekickGoldIngot", "Chance for a sidekick to have a Gold Ingot (offhand).", ()->Items.GOLD_INGOT, EquipmentSlot.OFFHAND, 0.2, 1, 0.0 );
	static final Config.ItemStack DIAMOND = new Config.ItemStack( "SidekickDiamond", "Chance for a sidekick to have a Diamond (offhand).", ()->Items.DIAMOND, EquipmentSlot.OFFHAND, 0.1, 1, 0.0 );
