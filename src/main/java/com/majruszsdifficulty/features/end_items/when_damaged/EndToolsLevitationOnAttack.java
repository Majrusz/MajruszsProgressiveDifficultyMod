...
import com.majruszsdifficulty.features.when_damaged.WhenDamagedApplyStackableEffectBase;
...
public class EndToolsLevitationOnAttack extends WhenDamagedApplyStackableEffectBase {
	...
	public boolean shouldBeExecuted( @Nullable LivingEntity attacker, LivingEntity target, DamageSource damageSource ) {
		if( attacker != null ) {
			...
			return !attacker.isShiftKeyDown() && EndItems.canInflictLevitation( heldItemStack.getItem() ) && super.shouldBeExecuted( attacker, target, damageSource ) && attacker.equals( damageSource.getDirectEntity() );
		}
