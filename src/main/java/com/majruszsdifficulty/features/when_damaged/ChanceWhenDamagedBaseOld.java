...
public abstract class ChanceWhenDamagedBaseOld extends ChanceFeatureBaseOld implements IWhenDamaged {
	public ChanceWhenDamagedBaseOld( String configName, String configComment, double defaultChance, GameStage.Stage minimumStage,
