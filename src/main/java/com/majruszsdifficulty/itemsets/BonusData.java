...
public class BonusData {
	...
	public MutableComponent createTranslatedText( ChatFormatting defaultFormatting, ChatFormatting valueFormatting ) {
		...
		TranslatableComponent TranslatableComponent = new TranslatableComponent( this.translationKey, params.toArray() );
		DECOMPOSE.invoke( TranslatableComponent );
		List< FormattedText > formattedTexts = DECOMPOSED_PARTS.get( TranslatableComponent );
