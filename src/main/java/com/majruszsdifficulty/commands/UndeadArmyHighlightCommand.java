...
@AutoInstance
public class UndeadArmyHighlightCommand extends DifficultyCommand {
	...
	private int handle( CommandData data ) throws CommandSyntaxException {
		...
		if( undeadArmy != null ) {
			...
			data.source.sendSuccess( Component.translatable( "commands.undeadarmy.highlighted", this.asVec3i( position ) ), true );
			return 0;
		}
