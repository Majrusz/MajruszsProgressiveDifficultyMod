...
public class SpiderQueenModel< Type extends Entity > extends HierarchicalModel< Type > {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_front_leg = partdefinition.addOrReplaceChild( "right_front_leg", CubeListBuilder.create()
			.texOffs( 0, 48 )
			.addBox( -1.5F, -15.0F, -1.5F, 3.0F, 15.0F, 3.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( -7.5F, 17.0F, -6.5F, 0.5236F, -0.7854F, -0.6981F ) );

		PartDefinition right_front_leg2 = right_front_leg.addOrReplaceChild( "right_front_leg2", CubeListBuilder.create()
			.texOffs( 12, 48 )
			.addBox( -1.0F, -14.0F, -1.5F, 3.0F, 14.0F, 3.0F, new CubeDeformation( -0.2F ) ), PartPose.offsetAndRotation( 0.5F, -15.0F, 0.0F, 0.0F, 0.0F, -1.7453F ) );

		PartDefinition right_front_leg3 = right_front_leg2.addOrReplaceChild( "right_front_leg3", CubeListBuilder.create()
			.texOffs( 12, 48 )
			.addBox( -1.5F, -13.5F, -1.5F, 3.0F, 14.0F, 3.0F, new CubeDeformation( -0.4F ) ), PartPose.offsetAndRotation( 0.5F, -13.5F, 0.0F, 0.0F, 0.0F, -1.0472F ) );

		PartDefinition right_middle_front_leg = partdefinition.addOrReplaceChild( "right_middle_front_leg", CubeListBuilder.create()
			.texOffs( 0, 48 )
			.addBox( -1.5F, -15.0F, -1.5F, 3.0F, 15.0F, 3.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( -7.5F, 17.0F, -6.5F, 0.1745F, -0.2618F, -0.5236F ) );
		...
		PartDefinition left_front_leg = partdefinition.addOrReplaceChild( "left_front_leg", CubeListBuilder.create()
			.texOffs( 0, 48 )
			.addBox( -1.5F, -15.0F, -1.5F, 3.0F, 15.0F, 3.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( 7.5F, 17.0F, -6.5F, -0.5236F, -2.3562F, 0.6981F ) );
		...
		PartDefinition left_middle_front_leg = partdefinition.addOrReplaceChild( "left_middle_front_leg", CubeListBuilder.create()
			.texOffs( 0, 48 )
			.addBox( -1.5F, -15.0F, -1.5F, 3.0F, 15.0F, 3.0F, new CubeDeformation( 0.0F ) ), PartPose.offsetAndRotation( 7.5F, 17.0F, -6.5F, -0.1745F, -2.8798F, 0.5236F ) );
