...
public class OceanShieldModel extends Model {
	...
	public ImmutableList< ModelPart > getModels() {
		return ImmutableList.of( this.plate,
			this.handle,
			this.spike1,
			this.spike2,
			this.spike3,
	...
	public static LayerDefinition createLayer() {
		...
		partDefinition.addOrReplaceChild( "spike1",
			CubeListBuilder.create().texOffs( 46, 0 ).addBox( -4.0F, -8.0F, -4.0F, 1.0F, 1.0F, 2.0F ),
			PartPose.offsetAndRotation( 0.0f, 0.0f, 0.0f, 0.0F, 0.17453292519943295F, 0.0F )
		);

		partDefinition.addOrReplaceChild( "spike2",
			CubeListBuilder.create().texOffs( 46, 0 ).addBox( 3.0F, -8.0F, -4.0F, 1.0F, 1.0F, 2.0F ),
			PartPose.offsetAndRotation( 0.0f, 0.0f, 0.0f, 0.0F, -0.17453292519943295F, 0.0F )
		);

		partDefinition.addOrReplaceChild( "spike3",
			CubeListBuilder.create().texOffs( 46, 0 ).addBox( 2.0F, -1.0F, -4.0F, 1.0F, 1.0F, 2.0F ),
			PartPose.offsetAndRotation( 0.0f, 0.0f, 0.0f, 0.0F, -0.17453292519943295F, 0.0F )
		);

		partDefinition.addOrReplaceChild( "spike4",
			CubeListBuilder.create().texOffs( 46, 0 ).addBox( -3.0F, -1.0F, -4.0F, 1.0F, 1.0F, 2.0F ),
			PartPose.offsetAndRotation( 0.0f, 0.0f, 0.0f, 0.0F, 0.17453292519943295F, 0.0F )
		);

		partDefinition.addOrReplaceChild( "spike5",
			CubeListBuilder.create().texOffs( 46, 0 ).addBox( -0.5F, 5.0F, -4.0F, 1.0F, 1.0F, 2.0F ),
			PartPose.offsetAndRotation( 0.0f, 0.0f, 0.0f, 0.12217304763960307F, 0.0F, 0.0F )
		);

		partDefinition.addOrReplaceChild( "spike6",
			CubeListBuilder.create().texOffs( 47, 1 ).addBox( -2.5F, -4.5F, -3.0F, 1.0F, 1.0F, 1.0F ),
			PartPose.ZERO
		);

		partDefinition.addOrReplaceChild( "spike7",
			CubeListBuilder.create().texOffs( 47, 1 ).addBox( 1.5F, -4.5F, -3.0F, 1.0F, 1.0F, 1.0F ),
			PartPose.ZERO
		);

		partDefinition.addOrReplaceChild( "spike8",
			CubeListBuilder.create().texOffs( 47, 1 ).addBox( -0.5F, 2.0F, -3.0F, 1.0F, 1.0F, 1.0F ),
			PartPose.ZERO
		);
