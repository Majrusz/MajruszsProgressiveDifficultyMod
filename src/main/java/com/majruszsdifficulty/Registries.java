...
public class Registries {
	...
	public static final RegistryObject< EnderiumSmithingTemplateItem > ENDERIUM_SMITHING_TEMPLATE = ITEMS.register( "enderium_upgrade_smithing_template", EnderiumSmithingTemplateItem::new );
