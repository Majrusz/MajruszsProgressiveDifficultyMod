...
public class OnBleedingTooltip {
	...
	public static class Data extends OnItemAttributeTooltip.Data {
		...
		public void addItem( double chance ) {
			this.add( EquipmentSlot.MAINHAND, new TranslatableComponent( "effect.majruszsdifficulty.bleeding.item_tooltip", TextHelper.percent( ( float )chance ), TextHelper.toRoman( this.amplifier + 1 ) )
				.withStyle( ChatFormatting.DARK_GREEN ) );
		}

		public void addArmor( EquipmentSlot slot, double chanceMultiplier ) {
			this.add( slot, new TranslatableComponent( "effect.majruszsdifficulty.bleeding.armor_tooltip", TextHelper.minPrecision( chanceMultiplier ) )
